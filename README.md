...
A simple Google Application script to convert a properly formatted Google Drive Document to the MarkDown (.md) format. 
...
## Usage
  ...
  * Adding this script to your doc (once per doc):
    ...
    * Clear the myFunction() default empty function and paste the contents of [converttomarkdown.gapps](https://raw.github.com/teocci/GDocs2md/master/converttomarkdown.gapps) into the code editor
    * File -> Save
...
* [Renato Mangini version](https://github.com/mangini/gdocs2md) 
...
If you want to modify and redistribute the script, just keep a reference to this repository 
or to the license info below:
